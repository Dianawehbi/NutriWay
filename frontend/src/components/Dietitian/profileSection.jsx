                ...
                <div className="lg:w-2/3 p-6 lg:p-8">
                    ...
                    <div className="mt-8 flex flex-wrap gap-3 justify-center lg:justify-start">
                        {user_id != dietitian_id && (
                            <button onClick={() => navigate('/bookappointment')} className="px-6 py-2 bg-green-600 text-white rounded-full hover:bg-green-700 transition-colors flex items-center">
                                <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        {user_id == dietitian_id && role == "dietitian" && (
                            <button onClick={() => navigate('/DietitianAppointments')} className="px-6 py-2 border border-green-600 text-green-600 rounded-full hover:bg-green-50 transition-colors flex items-center">
                                <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        {user_id == dietitian_id && role == "dietitian" && (
                            <button onClick={() => navigate('/DietitianAvailability')} className="px-6 py-2 border border-green-600 text-green-600 rounded-full hover:bg-green-50 transition-colors flex items-center">
                                <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />
                                </svg>
                                Set Availability
